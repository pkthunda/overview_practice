class TimeEntriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @time_entry.save
        format.html { redirect_to @time_entry, notice: 'Time_entry was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @time_entry.update(time_entry_params)
        format.html { redirect_to @time_entry, notice: 'Time_entry was successfully updated.' }
  ...
  # DELETE /time_entrys/1
  # DELETE /time_entrys/1.json
  def destroy
    @time_entry.destroy
    respond_to do |format|
      format.html { redirect_to time_entries_url, notice: 'Time_entry was successfully destroyed.' }
